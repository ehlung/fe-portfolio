  ...
  projects: [
    {
      ...
      description:
        '여러 명이 모일 때 약속 시간과 장소를 정하는 과정을 줄여주는 서비스입니다. 장소 추천 영역을 맡아 출발지 입력, 추천 결과 지도·카드 시각화, 참여자별 이동 경로 표시를 구현했습니다.',
    ...
    },
    {
      ...
      description:
        '떨어져 사는 가족이 일상을 영상으로 기록하고 함께 나누는 가족 아카이빙 서비스입니다. 프론트엔드를 단독으로 맡아 화면 설계와 구현, 영상 촬영 기능, 얼굴 인식 서버 연동, 배포를 담당했습니다.',
