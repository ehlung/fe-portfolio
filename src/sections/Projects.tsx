      ...
      <ul className="m-0 list-none p-0">
        {content.projects.map((project, i) => {
          ...
          return (
            ...
            >
                <div
                className={`project-image relative z-[1] col-span-full row-start-1 h-full opacity-25 md:col-span-7 md:opacity-100
                ...
                >
                <p className="my-2.5 font-mono text-[13px] text-teal">Featured Project</p>
                ...
                <p className="mb-3 text-[16px] text-slate-mid">{project.subtitle}</p>

                <div className="relative z-[2] rounded bg-transparent py-5 text-slate-mid shadow-none md:bg-navy-light md:p-6.25 md:shadow-[0_10px_30px_-15px_rgba(2,12,27,0.7)]">
                  ...
                  className={`relative z-[2] mt-4 flex items-center text-slate-main
                      ${isEven ? '-ml-2.5 md:ml-0 md:mr-[-10px] md:justify-end' : '-ml-2.5 md:justify-start'}`}
                  >
                    {project.githubUrl && (
                      <a
